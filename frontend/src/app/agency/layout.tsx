  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className="hidden md:flex md:w-64 flex-col bg-background border-r">
        <div className="p-6">
          <h2 className="text-2xl font-bold">Upzento Agency</h2>
        </div>
        ...
        <div className="p-4 border-t">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <span className="ml-2 font-medium">Agency Admin</span>
            </div>
            <ThemeToggle />
          </div>
          <Link 
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="md:hidden bg-background border-b p-4">
          <div className="flex items-center justify-between">
            <h2 className="font-bold">Upzento Agency</h2>
            <ThemeToggle />
          </div>
        </header>
